...
class _ProfileViewState extends State<ProfileView> {
  ...
  void _showPhoneNumberSharingSettings() {
    showModalBottomSheet(
      ...
      shape: const RoundedRectangleBorder(borderRadius: BorderRadius.vertical(top: Radius.circular(20))),
      builder: (BuildContext context) {
        return PhoneNumberSharingSheet(
          isDarkMode: isDarkMode,
          darkModeValue: darkModeValue,
          shareMobile: pushNotifications,
          removeShareNotification: emailNotifications,
          autoSync: smsNotifications,
          onShareMobileChanged: (value) => setState(() => pushNotifications = value),
          onRemoveShareNotificationChanged: (value) => setState(() => emailNotifications = value),
          onAutoSyncChanged: (value) => setState(() => smsNotifications = value),
          title: 'phone_number_sharing'.tr(),
